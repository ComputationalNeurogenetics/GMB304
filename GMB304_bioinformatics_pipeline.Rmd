...
### b) Plot QC values (Question 1: What are these values, how would you interpret the results?)
```{r Plot QC values}
...
### a) Plot variable features (Question 2: What are these features? What do they represent?)
...
## 8.	Plot Std vs PC components (Question 4:This is important plot, what does it tell? How it is related to previous question?)
...
## 9.	Find clusters of cells within the reduced dimensional space (Question 5: Clusters based on what?)
...
## 13.	Finding genes expressed in serotonergic cluster (Question 7: Are these specific for 5-HT neuron precursors? What is the difference between expressed and diff. expressed? What is the third possible way to characterize uniqueness of a transcriptomic profile?)
