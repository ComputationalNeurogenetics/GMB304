...
```{r Install additional libraries, include=FALSE}
### R image used in CSC notebooks environment does not yet have all libraries installed. You should install missing ones.
BiocManager::install(c("DOSE","clusterProfiler", "org.Mm.eg.db","pathview", "msigdbr","rWikiPathways","magick"))
...
loc2gene <- read.gmt("./gene_set_library_up_crisp.gmt")
